...
<p align="center">
  ...
  <a href="https://github.com/MeiSiristhebest/recipe-planner-app/blob/master/LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue?style=flat-square" alt="License" /></a>
...
sequenceDiagram
    ...
    API->>Engine: ① unit normalisation ② identical ingredients summed  ③ aisle grouping
...
erDiagram
    ...
    USER ||--o{ MEAL_PLAN : "created"
    USER ||--o{ SHOPPING_LIST : "owns"
    USER ||--o{ RECENTLY_VIEWED : "viewed"

    RECIPE ||--o{ CATEGORY_ON_RECIPE : "categorized"
    RECIPE ||--o{ TAG_ON_RECIPE : "tagged"
    RECIPE ||--o{ RECIPE_INGREDIENT : "has"
    RECIPE ||--o{ MEAL_PLAN_ITEM : "included in"

    MEAL_PLAN ||--o{ MEAL_PLAN_ITEM : "contains"
    SHOPPING_LIST ||--o{ SHOPPING_LIST_ITEM : "contains"
    SHOPPING_LIST_ITEM }o--|| RECIPE_INGREDIENT : "aggregates"

    CATEGORY ||--o{ CATEGORY_ON_RECIPE : "has"
    TAG ||--o{ TAG_ON_RECIPE : "has"
    INGREDIENT_CATEGORY ||--o{ RECIPE_INGREDIENT : "categorizes"
    INGREDIENT_CATEGORY ||--o{ SHOPPING_LIST_ITEM : "groups"
```
...
> Read [`CONTRIBUTING.md`](https://github.com/MeiSiristhebest/recipe-planner-app/blob/master/CONTRIBUTING.md) for the full contributor guide.
...
Full license text: [`LICENSE`](https://github.com/MeiSiristhebest/recipe-planner-app/blob/master/LICENSE).
