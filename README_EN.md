...
- **Disclosing vulnerabilities:** Email **`maox_neta@foxmail.com`**. First response within 48 hours; critical bugs get a patch within 72 hours. **Never detail an unfixed vulnerability in a public GitHub Issue.**
